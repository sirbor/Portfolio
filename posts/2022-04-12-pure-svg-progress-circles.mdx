...
## [View The Demo](https://codepen.io/sirbor/pen/GRbYvXM)
...
![SVG progress circle base](/posts/2016-04-12-pure-svg-progress-circles/svg_progress_circle_one.png)
...
![SVG progress circle build](/posts/2016-04-12-pure-svg-progress-circles/svg_progress_circle_two.png)
...
![Offsetting](/posts/2016-04-12-pure-svg-progress-circles/svg_progress_offset.gif)
...
I've added a slightly more pimped version up on [CodePen](https://codepen.io/sirbor/pen/GRbYvXM), which also has some further docs about the maths in the code. If you have any questions regarding this, or if it doesn't work, feel free to leave a comment below!

---

_Update: Just out of interest, I have also added a JS version [here](https://codepen.io/sirbor/pen/GRbYvXM)._
